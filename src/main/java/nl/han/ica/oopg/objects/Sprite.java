...
public class Sprite {
     ...
     *
     * @param image The PImage that should be used
     */
     ...
     *
     * @param fileName The filename o the sprite
     */
     ...
     *
     * @param width  The width of the resized sprite
     * @param height The height of the resized sprite
     */
